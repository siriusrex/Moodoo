...
var mooderatorWidth=$(window).width()-110;
...
function drawMiniGraph(moodData){	   
	...
	ctxMini.stroke();
	$('#miniGraphSlider').css('width', $('#miniGraph').width());	
	setMiniGraphSlider();
...
function onMouseMoveSlider(e, leftOrRight){
	...
	if (leftOrRight=='left'){
		...
		$('#miniGraphSlider').css('width', $('#miniGraph').width()-xpos+'px');
		...
		$('#miniGraphSlider').css('margin-left', xpos-dragOffset+'px');
	}
