...
function onViewportResize(){
	...
	var newSliderWidth=newViewportWidth*sliderWidthRatio;
	...
	var tempTop=$('#miniGraphSlider').offset().top;
	
	$('#miniGraphSlider').offset({top: tempTop, left: newSliderPos});
...
function onMouseMoveSlider(e, leftOrRight){
	...
	if (leftOrRight=='left'){
		...
		var rightBarrier=$('#miniGraph').width()+$('#miniGraph').offset().left-5;
...
function onMouseUpSlider(e){
	...
	sliderWidthRatio=$('#miniGraphSlider').width()/($(window).width()-110);
	sliderPosRatio=$('#miniGraphSlider').offset().left/($(window).width()-110);
	mooderatorZoomRatio=mooderatorWidth/($(window).width()-110);
	
	//console.log('at mouseup, sliderWidthRatio='+sliderWidthRatio+', sliderPosRatio='+sliderPosRatio);
