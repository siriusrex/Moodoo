...
function zoomChangeTouch(gestureScale, gestureX){
   ...
   if (mooderatorWidth < ($('#mooderatorGraph').width() - 10)) {
    ...
    var midPointOnWholeGraph=baseX+touchMidPointAtStartGesture;
    ...
    baseX = baseXAtStartGesture-scrollAmount;
	...
	logIt('zoomChangeTouch: $("#mooderatorGraph").width()-mooderatorWidth='+$("#mooderatorGraph").width()-mooderatorWidth);
	
	
    if (baseX+mooderatorWidth <= $('#mooderatorGraph').width()) {
        baseX = $('#mooderatorGraph').width()-mooderatorWidth;
    }
