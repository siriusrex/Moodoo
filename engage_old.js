...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://moodoo.rpxnow.com";
...
if (!janrain.settings.actionText)janrain.settings.actionText = "Sign in or sign up with:";
if (typeof janrain.settings.fontColor === 'undefined')janrain.settings.fontColor = "red";
if (typeof janrain.settings.fontFamily === 'undefined')janrain.settings.fontFamily = "Raleway, sans-serif";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "kckkfpidnmmiffioolgp";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://moodoo.rpxnow.com";
janrain.settings.permissions = [];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["google","openid","twitter","facebook"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "378277215632047";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://moodoo.rpxnow.com";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('2013.bergamot_widgets_332');
    return path;
}
