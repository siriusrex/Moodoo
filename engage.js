...
if (typeof janrain.settings.fontFamily === 'undefined')janrain.settings.fontFamily = "Helvetica, lucida grande, Verdana, sans-serif";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('1.104.1_widgets_454');
    return path;
}
