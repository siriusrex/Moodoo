...
header('Access-Control-Allow-Origin: https://moodoo.net');
...
function getUser($postID, $socialID){
...
function executeQuery($userQuery){
	...
	if ($userResult) {
		...
		//check if there are multiple matches for the postID or socialID
